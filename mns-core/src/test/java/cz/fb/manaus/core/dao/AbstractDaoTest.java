...
abstract public class AbstractDaoTest extends AbstractDatabaseTestCase {
    ...
    protected BetAction createAndSaveBetAction(Market market, Date date, Map<String, String> values, String betId) {
        var betAction = ModelFactory.newAction(BetActionType.PLACE, date, new Price(2d, 3d, Side.LAY), market, CoreTestFactory.DRAW);
    ...
    protected SettledBet createMarketWithSingleSettledBet() {
        ...
        var bet = ModelFactory.newSettled(action.getSelectionId(), "x", 5, now, action.getPrice());
    ...
    protected void createBet() {
        ...
        var prices = ModelFactory.newPrices(1, market, createRPs(2.1d, 2.2d), new Date());
        ...
        var prices2 = ModelFactory.newPrices(1, market, createRPs(2.3d, 2.5d), new Date());
    ...
    private BetAction createAction(Market market, MarketPrices prices, String betId) {
        var place = ModelFactory.newAction(BetActionType.PLACE, new Date(), new Price(2.2d, 2.1d, Side.LAY),
