...
public class MarketBook {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("isMarketDataDelayed", isMarketDataDelayed)
                .add("status", status)
                .add("betDelay", betDelay)
                .add("bspReconciled", bspReconciled)
                .add("complete", complete)
                .add("inplay", inplay)
                .add("numberOfWinners", numberOfWinners)
                .add("numberOfRunners", numberOfRunners)
                .add("numberOfActiveRunners", numberOfActiveRunners)
                .add("lastMatchTime", lastMatchTime)
                .add("totalMatched", totalMatched)
                .add("totalAvailable", totalAvailable)
                .add("crossMatching", crossMatching)
                .add("runnersVoidable", runnersVoidable)
                .add("version", version)
                .add("runners", runners)
                .toString();
    }
