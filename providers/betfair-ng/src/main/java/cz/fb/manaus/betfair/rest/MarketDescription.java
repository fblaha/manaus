...
public class MarketDescription {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("settleTime", settleTime)
                .add("bettingType", bettingType)
                .add("turnInPlayEnabled", turnInPlayEnabled)
                .add("marketType", marketType)
                .add("regulator", regulator)
                .add("marketBaseRate", marketBaseRate)
                .add("discountAllowed", discountAllowed)
                .add("wallet", wallet)
                .add("rules", rules)
                .add("rulesHasDate", rulesHasDate)
                .add("clarifications", clarifications)
                .toString();
    }
}
