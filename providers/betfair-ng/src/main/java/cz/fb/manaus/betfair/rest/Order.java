...
public class Order {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("price", price)
                .add("size", size)
                .add("bspLiability", bspLiability)
                .add("placedDate", placedDate)
                .add("avgPriceMatched", avgPriceMatched)
                .add("sizeMatched", sizeMatched)
                .add("sizeRemaining", sizeRemaining)
                .add("sizeLapsed", sizeLapsed)
                .add("sizeCancelled", sizeCancelled)
                .add("sizeVoided", sizeVoided)
                .toString();
    }
}
