...
open class CompetitionUnprofitableCategoriesFilter protected constructor() : AbstractUnprofitableCategoriesRegistry("competition", Duration.ofDays(120), Optional.empty<Side>(), -30.0, PREFIX, mapOf(20 to 2, 15 to 2, 10 to 2)) {
    companion object {
